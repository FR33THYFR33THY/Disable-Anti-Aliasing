...
"@
Set-Content -Path "$env:SystemRoot\Temp\forcedlaa.nip" -Value $MultilineComment -Force
# import config
Start-Process -wait "$env:SystemRoot\Temp\inspector.exe" -ArgumentList "$env:SystemRoot\Temp\forcedlaa.nip"
show-menu
